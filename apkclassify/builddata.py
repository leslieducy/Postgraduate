...
out_file_name = "./prunedata/point.csv"
out_train_name = "./prunedata/train.csv"
out_train_res_name = "./prunedata/trainresult.csv"
out_test_name = "./prunedata/test.csv"
out_test_res_name = "./prunedata/testresult.csv"
